This is a test of the charting libraries that may be used for internal dashboards, it was forked from a 
 [Create React App](https://github.com/facebookincubator/create-react-app). The libraries tested in this repo include, Highcharts, ChartJs and Plotly.
